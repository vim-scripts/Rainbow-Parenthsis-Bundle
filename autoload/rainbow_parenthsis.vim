...
function rainbow_parenthsis#Activate()
    ...
    highlight default level5c  ctermfg=darkcyan     guibg=AntiqueWhite guifg=RoyalBlue3
    ...
    highlight default level10c ctermfg=black        guibg=LemonChiffon guifg=SeaGreen3
    ...
    highlight default level14c ctermfg=darkcyan     guibg=AliceBlue    guifg=SeaGreen3
