...
function rainbow_parenthesis#Activate ()
	...
	highlight default hlLevel10			ctermfg=darkgreen			guifg=green1
	highlight default hlLevel11			ctermfg=darkcyan			guifg=springgreen1
	highlight default hlLevel12			ctermfg=darkred				guifg=cyan1
	highlight default hlLevel13			ctermfg=darkmagenta			guifg=slateblue1
	highlight default hlLevel14			ctermfg=brown				guifg=magenta1
	highlight default hlLevel15			ctermfg=gray				guifg=purple1
	...
	highlight default hlLevel10			ctermfg=darkmagenta			guifg=DarkOrchid3
	highlight default hlLevel11			ctermfg=Darkblue			guifg=firebrick3
	highlight default hlLevel12			ctermfg=darkgreen			guifg=RoyalBlue3
	highlight default hlLevel13			ctermfg=darkcyan			guifg=SeaGreen3
	highlight default hlLevel14			ctermfg=darkred				guifg=DarkOrchid3
	highlight default hlLevel15			ctermfg=red				guifg=firebrick3
	...
	highlight default hlLevel10			ctermfg=darkmagenta guibg=LemonChiffon	guifg=DarkOrchid3
	highlight default hlLevel11			ctermfg=Darkblue    guibg=LemonChiffon	guifg=firebrick3
	highlight default hlLevel12			ctermfg=darkgreen   guibg=AliceBlue	guifg=RoyalBlue3
	highlight default hlLevel13			ctermfg=darkcyan    guibg=AliceBlue	guifg=SeaGreen3
	highlight default hlLevel14			ctermfg=darkred     guibg=AliceBlue	guifg=DarkOrchid3
	highlight default hlLevel15			ctermfg=red	    guibg=AliceBlue	guifg=firebrick3
    else
	...
	highlight default hlLevel8  ctermbg=LightGray	ctermfg=brown	    guibg=AliceBlue	guifg=RoyalBlue3
	highlight default hlLevel9  ctermbg=LightGray	ctermfg=Darkblue    guibg=AliceBlue	guifg=SeaGreen3
	highlight default hlLevel10 ctermbg=LightGray	ctermfg=darkgray    guibg=AliceBlue	guifg=DarkOrchid3
	highlight default hlLevel11 ctermbg=LightGray	ctermfg=darkgreen   guibg=AliceBlue	guifg=firebrick3
	highlight default hlLevel12 ctermbg=LightGray	ctermfg=darkcyan    guibg=LemonChiffon	guifg=RoyalBlue3
	highlight default hlLevel13 ctermbg=LightGray	ctermfg=darkred	    guibg=LemonChiffon	guifg=SeaGreen3
	highlight default hlLevel14 ctermbg=LightGray	ctermfg=darkmagenta guibg=LemonChiffon	guifg=DarkOrchid3
	highlight default hlLevel15 ctermbg=LightGray	ctermfg=gray	    guibg=LemonChiffon	guifg=firebrick3
    endif
...
endfunction rainbow_parenthesis#Activate " }}} 1
...
function rainbow_parenthesis#All ()
    call rainbow_parenthesis#LoadRound ()
    call rainbow_parenthesis#LoadSquare ()
    call rainbow_parenthesis#LoadBraces ()
    call rainbow_parenthesis#LoadChevrons ()
    call rainbow_parenthesis#Activate ()
endfunction rainbow_parenthesis#All
...
function rainbow_parenthesis#LoadRound ()
    ...
    syntax region Paren10 transparent matchgroup=hlLevel10 start='(' end=')' contains=TOP containedin=Paren9  contained
    syntax region Paren11 transparent matchgroup=hlLevel11 start='(' end=')' contains=TOP containedin=Paren10 contained
    syntax region Paren12 transparent matchgroup=hlLevel12 start='(' end=')' contains=TOP containedin=Paren11 contained
    syntax region Paren13 transparent matchgroup=hlLevel13 start='(' end=')' contains=TOP containedin=Paren12 contained
    syntax region Paren14 transparent matchgroup=hlLevel14 start='(' end=')' contains=TOP containedin=Paren13 contained
    syntax region Paren15 transparent matchgroup=hlLevel15 start='(' end=')' contains=TOP containedin=Paren14 contained
